    ...
    return (
        <Carousel>
            <CarouselContent>
                ...
                <CarouselItem className="flex flex-col justify-between items-center">
                    <img className="w-[50vw] h-[50vw] xl:w-[600px] xl:h-[600px] " src="https://images.unsplash.com/photo-1658963654546-593c6ea57ce4?q=80&w=1480&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"></img>
                    <div className="w-[50vw] xl:w-[600px] flex flex-col justify-between items-start">
                        <h3 className="text-white">Title</h3>
                        <p className="text-[gray]">Describe</p>
                    </div>
